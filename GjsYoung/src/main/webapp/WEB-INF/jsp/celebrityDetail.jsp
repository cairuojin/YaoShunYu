...
<div class="features">
    <div class="container">
        <h3 class="head" style="font-family: 微软雅黑"><span aria-hidden="true"><img
                src="images/main/menu.png"></span>${celebrity.evaluate}</h3>
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active" style="margin-left: 20px"><a href="#home" id="home-tab"
                                                                                    role="tab" data-toggle="tab"
                                                                                    aria-controls="home"
                                                                                    aria-expanded="true">${celebrityDetails.get(0).title}</a>
                </li>
                <c:forEach items="${celebrityDetails}" var="s" begin="1" end="${celebrityDetails.size()}" varStatus="i">
                    <li role="presentation" style="margin-left: 20px"><a href="#Feature${i.index}" role="tab"
                                                                         id="Feature1-tab" data-toggle="tab"
                                                                         aria-controls="Feature${i.index}">${s.title}</a>
                    </li>
                </c:forEach>
            </ul>
            <div id="myTabContent" class="tab-content">
                ...
                <c:forEach items="${celebrityDetails}" var="single" begin="1" end="${celebrityDetails.size()}"
                           varStatus="i">
                    <c:if test="${i.index %2 != 0}">
                        <div role="tabpanel" class="tab-pane fade" id="Feature${i.index}"
                             aria-labelledby="Feature${i.index}-tab">
                            <div class="w3agile_tabs">
