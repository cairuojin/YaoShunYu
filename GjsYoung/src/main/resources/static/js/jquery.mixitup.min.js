...
(function (e) {
    function m(d, b, h, c, a) {
        ...
        var r = a.targetSelector, u = c.find(r);
        u.each(function () {
            this.data = {}
        });
        var k = u.parent();
	...
	")
            ...
            if (!c.newOrder.length) {
                for (var g = c.startOrder.slice(), n = g.length, r = n; r--;) {
                    var m = parseInt(Math.random() * n), k = g[r];
                    g[r] = g[m];
                    g[m] = k
                }
                c.newOrder = g
    ...
    var w = {
        init: function (d) {
            ...
            return this.each(function () {
                var b = this.config;
                if (e.isArray(d)) var h = d[0], c = d[1]; else h = d, c = "desc";
    ...
    Array.prototype.compare = function (d) {
        ...
        for (var b = 0; b < d.length; b++) if (this[b].compare &&
